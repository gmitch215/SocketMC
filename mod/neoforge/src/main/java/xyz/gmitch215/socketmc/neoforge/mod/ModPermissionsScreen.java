...
public final class ModPermissionsScreen extends Screen {
    ...
    public void init(int page0) {
        ...
        header.addChild(new StringWidget(MainScreen.PERMISSIONS, this.font), LayoutSettings::alignHorizontallyCenter);
        ...
        if (current == null) {
            ...
            StringWidget text = new StringWidget(def, this.font) {
                @Override
                public void onClick(double mouseX, double mouseY, int button) { minecraft.setScreen(screen(null)); }
            };
            left.addChild(text);
        }
        ...
        for (final SocketPlugin plugin : plugins) {
            ...
            if (same) {
                ...
                StringWidget text = new StringWidget(name, this.font) {
                    @Override
                    public void onClick(double mouseX, double mouseY, int button) { minecraft.setScreen(screen(plugin)); }
                };
