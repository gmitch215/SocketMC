    ...
    public static Toast toMinecraft(xyz.gmitch215.socketmc.screen.Toast toast) {
        return switch (toast.getType()) {
            ...
            case 1 -> {
                ...
                yield SystemToast.multiline(minecraft, id, FabricUtil.fromJson(title), FabricUtil.fromJson(message));
            }
            ...
            case 2 -> {
                ...
                yield new TutorialToast(icon, FabricUtil.fromJson(title), FabricUtil.fromJson(message), progressable);
            }
